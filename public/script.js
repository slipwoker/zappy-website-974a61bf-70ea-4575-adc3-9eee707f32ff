document.addEventListener('DOMContentLoaded', function() {
    ...
    function showSuccessMessage(form) {
        ...
        successElement.style.cssText = 'background-color: #d4edda; color: #155724; padding: 1rem; border-radius: 4px; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '974a61bf-70ea-4575-adc3-9eee707f32ff',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '974a61bf-70ea-4575-adc3-9eee707f32ff';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '974a61bf-70ea-4575-adc3-9eee707f32ff';
